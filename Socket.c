...
int main()
{
    ...
    while(1)
    {
        ...
        rectangle(frame1, roi1, Scalar(0,255,0), 5);  /*在原图中把ROI区域用矩形标出*/
		rectangle(frame1, roi2, Scalar(0,255,0), 5);
		rectangle(frame1, roi3, Scalar(0,255,0), 5);
		rectangle(frame1, roi4, Scalar(0,255,0), 5);
...
Mat RGB_detect(Mat& img)
{
    ...
    */
    ...
    threshold(detect,detect,0.1,255,CV_THRESH_BINARY);
    return detect;
}
